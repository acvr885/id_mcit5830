...
def scan_blocks(chain, start_block, end_block, contract_address, eventfile='deposit_logs.csv'):
    ...
    if end_block < start_block:
        raise ValueError(f"end_block < start_block! end_block={end_block}, start_block={start_block}")
    ...
    # Use a single filter if range is small; otherwise scan block-by-block
